    ...
    <div id="wrapper">
		...
		<div id="page-wrapper" >
				...
				<div class="col-md-7">
					<div class="panel panel-default">
						<div class="panel-heading">
							Se muestran las placas que han sido avistadas
						</div>        
									  
						<div class="panel-body">
							<div class="form-group">
								<label>Seleccionar n&uacute;mero de placa</label>
								...
								<?php
									...
									$sql ="SELECT DISTINCT placa FROM avistados";
									$result = $conn->query($sql);
									if ($result->num_rows > 0) {
									// output data of each row
										while($row = $result->fetch_assoc()) {

											echo "<option class='comboPlaca' id='".$row['placa']."'>".$row['placa']."</option>"; 
			...
			<div class="col-md-5">
				...
				<div id="map" style="width: 980px; height: 650px">
